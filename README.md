...
- Vault files can already be streamed through authenticated Django preview/download endpoints.
- Direct storage URLs such as `file_url` and avatar URLs should be replaced or supplemented before making the entire bucket private.
